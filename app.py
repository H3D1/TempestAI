...
# app.config['MAIL_USERNAME'] = 'bejaouimedhedi2@gmail.com'  # Replace with your email
# app.config['MAIL_PASSWORD'] = 'your_password'  # Replace with your password or use environment variables
# mail = Mail(app)
...
#     msg = Message("User Feedback", sender='your_email@gmail.com', recipients=['bejaouimedhedi2@gmail.com'])
...
#     temp_category = 'cold' if temperature < 10 else ('warm' if temperature < 25 else 'hot')
...
#         f"Recommended Activities: {', '.join(unique_recommendations)}."
#     )
...
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'bejaouimedhedi2@gmail.com'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'Dohdoh374'  # Replace with your password or use environment variables
mail = Mail(app)
